...
class SideNav extends \yii\widgets\Menu
{
    ...
    public function init()
    {
        ...
        $this->linkTemplate = '<a class="{active}" href="{url}">{icon}{label}</a>';
...
//            Html::addCssClass($this->headingOptions, 'panel-heading');
            $heading = Html::tag('header', '<i class="fa fa-wrench" aria-hidden="true"></i><strong>' . $this->heading . '</strong>', $this->headingOptions);
        }
