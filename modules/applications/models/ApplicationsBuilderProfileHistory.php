...
/**
 * This is the model class for table "tbl_applications_builder_profile_history".
 *
 * @property integer $id
 ...
 */
class ApplicationsBuilderProfileHistory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_applications_builder_profile_history';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['application_id', 'builder_profile_exsistence', 'builder_profile_staff', 'builder_profile_area', 'builder_profile_type_of_office', 'builder_profile_is_reachable', 'builder_profile_address_verification', 'created_by', 'updated_by', 'is_deleted'], 'integer'],
