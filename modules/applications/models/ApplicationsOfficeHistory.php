...
/**
 * This is the model class for table "tbl_applications_office_history".
 *
 * @property integer $id
 ...
 */
class ApplicationsOfficeHistory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_applications_office_history';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['application_id', 'office_employment_years', 'office_status', 'office_is_reachable', 'office_available_status', 'office_shifted_tenure', 'office_address_verification', 'created_by', 'updated_by', 'is_deleted'], 'integer'],
