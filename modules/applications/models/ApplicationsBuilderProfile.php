...
class ApplicationsBuilderProfile extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['application_id', 'builder_profile_exsistence', 'builder_profile_staff', 'builder_profile_area', 'builder_profile_type_of_office', 'builder_profile_is_reachable', 'builder_profile_address_verification'], 'integer'],
