...
/**
 * This is the model class for table "tbl_applications_busi_history".
 *
 * @property integer $id
 ...
 */
class ApplicationsBusiHistory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_applications_busi_history';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['application_id', 'busi_staff_declared', 'busi_staff_seen', 'busi_years_in_business', 'busi_type_of_business', 'busi_ownership_status', 'busi_area', 'busi_locality', 'busi_locality_type', 'busi_activity_seen', 'busi_status', 'busi_is_reachable', 'busi_available_status', 'busi_shifted_tenure', 'busi_address_verification', 'created_by', 'updated_by', 'is_deleted'], 'integer'],
