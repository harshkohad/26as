...
class ApplicationsNocSoc extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['application_id', 'noc_soc_society_type', 'created_by', 'updated_by', 'is_deleted'], 'integer'],
            [['created_on', 'updated_on', 'noc_soc_address_pincode', 'noc_soc_is_reachable', 'noc_soc_address_lat', 'noc_soc_address_long'], 'safe'],
