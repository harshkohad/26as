...
class ApplicationsSearch extends Applications
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'mobile_user_assigned_date' => $this->mobile_user_assigned_date,
            'mobile_user_status' => $this->mobile_user_status,
            'mobile_user_status_updated_on' => $this->mobile_user_status_updated_on,
