...
/**
 * This is the model class for table "tbl_applications_property_apf_history".
 *
 * @property integer $id
 ...
 */
class ApplicationsPropertyApfHistory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_applications_property_apf_history';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['application_id', 'property_apf_property_status', 'property_apf_no_of_workers', 'property_apf_total_flats', 'property_apf_how_many_sold', 'property_apf_total_shops', 'property_apf_area', 'property_apf_is_reachable', 'property_apf_address_verification', 'created_by', 'updated_by', 'is_deleted'], 'integer'],
