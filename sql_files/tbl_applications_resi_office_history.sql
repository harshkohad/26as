DROP TABLE IF EXISTS `tbl_applications_resi_office_history`;
CREATE TABLE `tbl_applications_resi_office_history` (
  `id` int(11) NOT NULL,
...
ALTER TABLE `tbl_applications_resi_office_history`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `tbl_applications_resi_office_history`
